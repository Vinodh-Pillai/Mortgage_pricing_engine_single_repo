...
@RestController
class AdjustmentUiController {
  private final PricingBffUiFallbackAdapter adapter;

  AdjustmentUiController(PricingBffUiFallbackAdapter adapter) {
    this.adapter = adapter;
  }

  @GetMapping("/api/v1/adjustments/evidence")
  Object adjustmentEvidence(
    ...
    return adapter.adjustmentEvidence(tenantContext, uiTraceId);
  }
}
