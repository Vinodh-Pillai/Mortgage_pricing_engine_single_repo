...
@RestController
class ComplianceUiController {
  private final PricingBffUiFallbackAdapter adapter;

  ComplianceUiController(PricingBffUiFallbackAdapter adapter) {
    this.adapter = adapter;
  }

  @GetMapping("/api/v1/compliance/evidence")
  Object complianceEvidenceRegistry(
    ...
    return adapter.complianceEvidenceRegistry(tenantContext, uiTraceId);
  }
}
