...
@Entity
@Table(name = "lock_replay_artifacts")
public class LockReplayArtifact {
    ...
    protected LockReplayArtifact() {
        // JPA only.
    }

    public static LockReplayArtifact create(
            UUID tenantId,
            UUID runId,
        ...
        LockReplayArtifact artifact = new LockReplayArtifact();
