...
export const pii25Personas: Pii25Persona[] = [
  ...
  },
  {
    ...
    authorizedRoutes: ['/pricing/analysis', '/pricing/margins', '/pricing/adjustments', '/pricing/rate-sheets', '/tenant/onboarding'],
    unauthorizedRoutes: ['/admin/governance', '/locks'],
  ...
  },
  {
    ...
    authorizedRoutes: ['/compliance/evidence', '/tenant/onboarding'],
