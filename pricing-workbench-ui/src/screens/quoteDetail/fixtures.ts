...
export const deterministicQuoteDetail: QuoteDetailView = {
  ...
  summary: {
    ...
    productRuleRefs: ['rule:loanpass:max-ltv-config-ref'],
    stipulationRefs: ['stipulation:income-documentation-required'],
    rateRefs: ['rate:note-rate:6.500', 'price:final:100.875'],
    lockPeriodOptions: ['lock-period:30'],
