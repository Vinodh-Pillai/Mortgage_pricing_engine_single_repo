...
export const marginProfitabilityScreenModule = createScreenModule({
  ...
  stateCoverage: ['loading', 'load-state', 'empty', 'blocked', 'needs-attention', 'ready', 'redacted', 'floor-evidence', 'approval', 'replay-evidence'],
  ...
  Component: lazy(async () => ({ default: MarginProfitabilityScreen })),
});
