...
export function Step5IncomeAssets({ fields, intake, errors, onChange }: { fields: ScenarioIntakeField[]; intake: BorrowerIntake; errors: IntakeFieldErrors; onChange: (field: keyof BorrowerIntake, value: string) => void }) {
