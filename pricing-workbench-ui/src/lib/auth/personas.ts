...
export const routePermissionRules: RoutePermissionRule[] = [
  ...
  { pattern: '/quote/*/pricing-waterfall', permissions: ['pricing:waterfall', 'quote:read'], match: 'any' },
  ...
  { pattern: '/pricing/adjustments', permissions: ['adjustment:read'], match: 'all' },
  ...
  { pattern: '/exceptions/concessions', permissions: ['margin:analyze', 'governance:read'], match: 'any' },
  ...
  { pattern: '/ops/escalations*', permissions: ['ops:manage'], match: 'all' },
  ...
  { pattern: '/security/events*', permissions: ['security:read', 'security:events'], match: 'any' },
  { pattern: '/quality/validation', permissions: ['quality:read', 'governance:read'], match: 'any' },
  { pattern: '/tenant/onboarding', permissions: ['tenant:manage', 'admin:*'], match: 'any' },
  { pattern: '/admin/tenants/new', permissions: ['tenant:manage', 'admin:*'], match: 'any' },
  ...
  { pattern: '/platform/tenant-context', permissions: ['tenant:read', 'admin:*'], match: 'any' },
  { pattern: '/audit/replay', permissions: ['audit:read', 'audit:replay'], match: 'any' },
  { pattern: '/advisory/ml/governance', permissions: ['model:governance'], match: 'all' },
  { pattern: '/advisory/ml/drift', permissions: ['model:read', 'model:governance'], match: 'any' },
  { pattern: '/advisory/ml', permissions: ['model:read'], match: 'all' },
