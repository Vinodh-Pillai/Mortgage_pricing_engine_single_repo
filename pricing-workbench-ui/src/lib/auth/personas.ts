...
export const routePermissionRules: RoutePermissionRule[] = [
  ...
  { pattern: '/pricing/waterfall/preview', permissions: ['pricing:read', 'quote:read'], match: 'any' },
  ...
  { pattern: '/user/profile', permissions: ['quote:read', 'partner:read', 'admin:*'], match: 'any' },
  { pattern: '/user/settings', permissions: ['quote:read', 'partner:read', 'admin:*'], match: 'any' },
  ...
  { pattern: '/journey-map/preview', permissions: ['quote:read'], match: 'all' },
  { pattern: '/exceptions/concessions', permissions: ['margin:read', 'governance:read'], match: 'any' },
  { pattern: '/partner-integrations*', permissions: ['partner:read'], match: 'all' },
