...
- Name: quote-intake\quote-intake.test.ts >> PII-25 quote intake E2E >> required field validation exposes ARIA errors and preserves focus
- Location: tests\e2e\quote-intake\quote-intake.test.ts:41:3
...
Call log:
  - waiting for getByRole('button', { name: /Create draft and continue/i })
...
```yaml
- main "LoanWeft" [ref=e4]:
  - generic [ref=e5]:
    - generic [ref=e6]:
      - generic [ref=e8]: ◇
      - paragraph [ref=e9]: Secure sign in
      - heading "LoanWeft" [level=1] [ref=e10]
      - paragraph [ref=e11]: Mortgage Pricing Engine
    - generic [ref=e12]:
      ...
      - generic [ref=e21]:
        ...
        - link "Forgot password?" [ref=e23] [cursor=pointer]:
          - /url: /forgot-password
      - paragraph [ref=e24]: Use your organization account to access LoanWeft.
```
