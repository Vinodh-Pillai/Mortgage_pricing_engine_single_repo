...
- Name: quote-intake\quote-intake.test.ts >> PII-25 quote intake E2E >> next, previous, progress clicks, save draft, resume, metadata panel, visual and keyboard paths are available
- Location: tests\e2e\quote-intake\quote-intake.test.ts:48:3
...
Locator: locator('[name="quoteIntent"], #quoteIntent').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[name="quoteIntent"], #quoteIntent').first()
