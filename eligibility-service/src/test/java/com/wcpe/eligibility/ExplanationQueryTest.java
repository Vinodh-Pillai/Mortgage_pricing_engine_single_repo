...
class ExplanationQueryTest {
    @Test
    void neverRerunsRules() throws Exception {
        EligibilityApplicationService applicationService = mock(EligibilityApplicationService.class);
        ...
        mockMvc.perform(get("/api/v1/tenants/11111111-1111-1111-1111-111111111111/quotes/22222222-2222-2222-2222-222222222222/options/33333333-3333-3333-3333-333333333333/eligibility-explanation")
                .header("X-Actor-Id", "actor-1")
                .header("X-Permissions", "quote:read")
                .header("X-Correlation-Id", "corr-1"))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.rules[0].evidenceId").value("ev1"));
